<x-painel.header title="EDITAR USUÁRIOS | {{env('APP_NAME')}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" name="nomeUsuario" id="nomeUsuario" value="{{$usuario->name}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <div class="input-group mb-3">
                                        <input type="text" name="emailUsuario" id="emailUsuario" value="{{$usuario->email}}"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>CIM</label>
                                    <div class="input-group mb-3">
                                        <input type="text" name="cimUsuario" id="cimUsuario" value="{{$usuario->cim}}"
                            ...
                            <div class="form-check ml-2 mb-4">
                                <input class="form-check-input" type="checkbox" name="administradorUsuario" value="" id="administradorUsuario" {{$usuario->administrador == 1 ? 'checked' : ''}}>
