    ...
    <div class="row justify-content-center">
      <div class="col-md-4 album-card mb-2">
        <div class="card d-flex flex-column" style="height: 100%;">
          <img src="https://static.vecteezy.com/system/resources/previews/017/395/386/non_2x/google-document-icon-free-png.png" class="card-img-top" alt="Álbum 1" style="height: 200px; object-fit: cover;">
      ...
      <div class="col-md-4 album-card mb-2">
        <div class="card d-flex flex-column" style="height: 100%;">
          <img src="https://static.vecteezy.com/system/resources/previews/017/395/386/non_2x/google-document-icon-free-png.png" class="card-img-top" alt="Álbum 2" style="height: 200px; object-fit: cover;">
          <div class="card-body d-flex flex-column" style="flex: 1;">
...
<section id="albuns" class="my-5">
  <div class="container text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-md-4 album-card mb-2">
        <div class="card d-flex flex-column" style="height: 100%;">
          <img src="https://images.squarespace-cdn.com/content/v1/5db9a570d2e92960a6db994f/2caa3c25-c67c-43af-8374-16ca4115db2d/DMS_1644.jpg" class="card-img-top" alt="Álbum 1" style="height: 200px; object-fit: cover;">
          <div class="card-body d-flex flex-column" style="flex: 1;">
      ...
      <div class="col-md-4 album-card mb-2">
        <div class="card d-flex flex-column" style="height: 100%;">
          <img src="https://babyherois.com.br/wp-content/uploads/2019/07/2019-08-o-que-nao-pode-faltar-em-uma-festa-no-sitio-802x506-1.jpg" class="card-img-top" alt="Álbum 2" style="height: 200px; object-fit: cover;">
          <div class="card-body d-flex flex-column" style="flex: 1;">
      ...
      <div class="col-md-4 album-card mb-2">
        <div class="card d-flex flex-column" style="height: 100%;">
          <img src="https://laranjeiras.camporeal.edu.br/content/uploads/2024/03/342368802_611007210910013_5727294774046424249_n.jpg" class="card-img-top" alt="Álbum 3" style="height: 200px; object-fit: cover;">
          <div class="card-body d-flex flex-column" style="flex: 1;">
